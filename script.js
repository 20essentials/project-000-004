...
console.log(
  "img1 ->",
  "https://gritaradio.com/wp-content/uploads/2020/12/SodaStereo_1985.jpg"
);
console.log(
  "img2,, img5, img6,  ->",
  "https://wallpapercave.com/wp/wp2023158.jpg"
);
console.log(
  "img8",
  "https://e.rpp-noticias.io/xlarge/2023/11/13/092409_1501423.webp"
);
console.log(
  "img4",
  "https://lh3.googleusercontent.com/09KHKfbT9CrQXLPKKhbfG3wviW5r-8n0jae3TLubt5hqtYM4epKXbIgSPzqVyhaillpdtGcdkC7VdVNM=w1440-h600-p-l90-rj"
);
console.log(
  "img7",
  "https://e.rpp-noticias.io/xlarge/2023/11/09/535553_1500254.webp"
);
console.log(
  "alert logo",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTl9qjFp-E8DWX6XN2ilPiCUp1bfn4_tit4OuAHqabBew&s"
);
console.groupEnd();
...
let putTitle = (titulo = `${nameBand} - LANDING `) => (d.title = titulo);
let d = document;
putTitle();
